...
<form class="layui-form layui-form-pane">
	<div class="my-btn-box">
	    <span class="fl">
	        ...
	        <div class="layui-input-inline">
	            <input name="id" type="text" autocomplete="off" placeholder="请输入趣闻ID" class="layui-input">
	        </div>
	        <div class="layui-input-inline">
	            <input name="commentContent" type="text" autocomplete="off" placeholder="请输入评论内容" class="layui-input">
	        </div>
    ...
    layui.use(['table', 'form', 'layer', 'vip_table'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'infoContent', title: '趣闻内容', width: 120}
                , {field: 'commentContent', title: '评论内容', width: 620}
                , {field: 'praiseNum', title: '点赞数', width: 80}
                , {field: 'createTime', title: '创建时间', width: 180}
                , {fixed: 'right', title: '操作', width: 100, align: 'center', toolbar: '#barOption'}
            ]]
            , id: 'dataTable'
            , url: '<c:url value="/cms/info/comment"></c:url>'
            , method: 'post'
            , page: true
        ...
        table.on('tool', function(obj){
            ...
            if(obj.event === 'edit'){
                layer.open({
	             	...
	             	shadeClose: true,
	             	title: '编辑评论',
	             	content: '<c:url value="/cms/info/edit/comment/'+data.id+'"></c:url>',
