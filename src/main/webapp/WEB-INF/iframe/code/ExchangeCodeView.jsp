    ...
    layui.use(['table', 'form', 'layer', 'vip_table'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'exchangeType', title: '类型', width: 120}
                , {field: 'exchangeId', title: '商品ID/增值服务ID', width: 100}
                , {field: 'exchangeCode', title: '兑换码', width: 180}
                , {field: 'exchangeStatus', title: '状态', width: 80}
                , {field: 'createTime', title: '创建时间', width: 180}
                , {field: 'exchangeTime', title: '兑换时间', width: 180}
            ]]
            , id: 'dataTable'
            , url: '<c:url value="/cms/code/exchange"></c:url>'
            , method: 'post'
            , page: true
