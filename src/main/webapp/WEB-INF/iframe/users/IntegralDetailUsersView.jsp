...
<script type="text/javascript">
    ...
    layui.use(['table', 'form', 'layer', 'vip_table'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                {field: 'idId', title: 'ID', width: 80}
                , {field: 'userNickName', title: '用户昵称', width: 180}
                , {field: 'userPhoneNumber', title: '用户手机号', width: 180}
                , {field: 'integralChange', title: '变动值', width: 120}
                , {field: 'integralAgo', title: '变动前', width: 120}
                , {field: 'integralAfter', title: '变动后', width: 120}
                , {field: 'timeChange', title: '变动时间', width: 180}
            ]]
            , id: 'dataTable'
            , url: '<c:url value="/cms/users/integral"></c:url>'
            , method: 'post'
