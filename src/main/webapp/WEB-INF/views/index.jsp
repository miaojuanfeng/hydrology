    ...
    <div class="layui-layout layui-layout-admin">
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                  <dd data-name="console">
                      <a lay-href="<c:url value="/station/62303350"></c:url>">宁都</a>
                  </dd>
                  <dd data-name="console">
                      <a lay-href="<c:url value="/station/62303500"></c:url>">汾坑</a>
                  </dd>
                  <dd data-name="console">
                      <a lay-href="<c:url value="/station/62303650"></c:url>">石城</a>
                  </dd>
              </dl>
            </li>
            ...
            <li data-name="home" class="layui-nav-item">
              <a href="javascript:;" lay-tips="模型" lay-direction="2">
                <i class="layui-icon layui-icon-home"></i>
                <cite>模型</cite>
              </a>
              <dl class="layui-nav-child">
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="<c:url value="/views/home/console"></c:url>" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
